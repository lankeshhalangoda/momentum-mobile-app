...
export default function LoginPage() {
  ...
  return (
    <main className="mx-auto min-h-[100dvh] w-full max-w-md overflow-y-auto px-5 pt-[calc(env(safe-area-inset-top)*0.5+0.2rem)] pb-[calc(env(safe-area-inset-bottom)*0.45+0.2rem)]">
      <div className="flex min-h-[calc(100dvh-1.25rem)] flex-col justify-center py-2">
            ...
            <label className="block">
              ...
              <div className="relative">
                ...
                <span className="pointer-events-none absolute right-3 top-1/2 inline-flex -translate-y-1/2 items-center gap-1 text-[0.65rem] font-semibold text-fg-subtle">
                  <EyeOff className="h-3.5 w-3.5" strokeWidth={1.9} aria-hidden />
                </span>
              </div>
            </label>
